...
<div class="container">
	...
	<div class="row clearfix" style="margin-top: 20px; ">
		<div class="col-md-3 column">
			<form role="form" action="${pageContext.request.contextPath}/searchAction!search.action" method="get" target="main_iframe">
		...
		<div class="col-md-9 column">
			<iframe frameborder="1" name="main_iframe" src="${pageContext.request.contextPath}/center.jsp" width="100%" height="500px"></iframe>
